...
public:
    tl::expected<ModuleReadingsCollection, Error> take_readings(ScanningContext &ctx, ConstructedModulesCollection const &modules, uint32_t reading_number, Pool &pool);
