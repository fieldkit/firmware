...
#define FK_MODULES_KIND_WATER_PH                   (0x04)
#define FK_MODULES_KIND_WATER_EC                   (0x05)
#define FK_MODULES_KIND_WATER_DO                   (0x06)
#define FK_MODULES_KIND_WATER_TEMP                 (0x07)
#define FK_MODULES_KIND_WATER_ORP                  (0x08)
