...
void board_configure_supply_controller() {
    ...
    SUPC->BOD33.reg = SUPC_BOD33_LEVEL(250) |
        SUPC_BOD33_HYST(10) |
...
void board_initialize(void) {
    ...
    SYSCTRL->DFLLMUL.reg = SYSCTRL_DFLLMUL_CSTEP(31) | // Coarse step is 31, half of the max value
        ...
        SYSCTRL_DFLLMUL_MUL((CPU_FREQUENCY + VARIANT_MAINOSC / 2) / VARIANT_MAINOSC); // External 32KHz is the reference
    ...
    // TODO(tannewt): Load this value from memory we've written previously. There isn't a value from the Atmel factory.
    uint32_t fine = 0x1ff;
