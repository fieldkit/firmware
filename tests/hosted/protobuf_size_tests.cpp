...
static void fake_global_state(GlobalState &gs, Pool &pool) {
    ...
    auto module_sensors = pool.malloc_with<SensorState, 10>({
        { .name = "sensor-0", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(0).calibrated },
        { .name = "sensor-1", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(1).calibrated },
        { .name = "sensor-2", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(2).calibrated },
        { .name = "sensor-3", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(3).calibrated },
        { .name = "sensor-4", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(4).calibrated },
        { .name = "sensor-5", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(5).calibrated },
        { .name = "sensor-6", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(6).calibrated },
        { .name = "sensor-7", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(7).calibrated },
        { .name = "sensor-8", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(8).calibrated },
        { .name = "sensor-9", .unit_of_measure = "m", .flags = 0, .has_live_vaue = true, .live_value = module_readings->get(9).calibrated },
    });
