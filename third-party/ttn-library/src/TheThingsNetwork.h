...
#define PROGMEM
#define fk_pgm_read_word(addr) (*(addr))
...
#define TTN_PWRIDX_AS920_923                                                                                                               \
    "1" // TODO: should be 0, but the current RN2903AS firmware doesn't accept that value (probably still using EU868: 1=14dBm)
...
enum ttn_fp_t { TTN_FP_EU868, TTN_FP_US915, TTN_FP_AU915, TTN_FP_AS920_923, TTN_FP_AS923_925, TTN_FP_KR920_923, TTN_FP_IN865_867 };

enum lorawan_class_t { CLASS_A, CLASS_B, CLASS_C };
